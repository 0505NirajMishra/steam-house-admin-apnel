...
<head>
    ...
    <meta charset="utf-8" />
    {{-- {{ asset('admin/dist/') }} --}}
  {{-- <link rel="shortcut icon" href="{{ isset($global_setting_data['favicon']) ? asset('files/settings/' . $global_setting_data['favicon'] . '') : asset('admin/dist/media/logos/150.ico') }}" /> --}}
           <link rel="shortcut icon" href="{{ asset('admin/dist/media/logos/steamhouse.ico') }}" />
    <!--begin::Fonts-->
